#%% Extract CalSimHydro Product A run outputs for CalSim 1971-2018 validation.
#
# Reads the "Product A" DSS runs for each CalSimHydro output DSS file
# (CS3L2015V0Hydro_SV, RiceOutput, HydroRebalanceSJRdemands) and writes
# standard validation CSVs: Part B, Part C, Year, Month, Value.
#
# Usage:
#     python _3_postprocess_all_for_calsim_validation.py
#%%
...
# DSS sources: (label, master-inventory DSS filter, path to Combined DSS file)
...
DSS_SOURCES = [
    {
        ...
        "dss_path":    str(_cshydro_runs / "CalSimHydro_Product_A" / "CS3L2015V0Hydro_SV.dss"),
        "output_name": "_cshydro_sv_productA",
    },
    {
        "label":       "RiceOutput",
        "inv_filter":  "RiceOutput.dss",
        "dss_path":    str(_cshydro_runs / "CalSimHydro_Product_A" / "RiceOutput.dss"),
        "output_name": "_cshydro_rice_productA",
    },
    {
        "label":       "HydroRebalanceSJRdemands",
        "inv_filter":  "RebalancedSJR_AW_TW_DP.dss",
        "dss_path":    str(_rebalance_runs / "Rebalance_Product_A" / "DSS" / "HydroRebalanceSJRdemands.dss"),
        "output_name": "_cshydro_rebalance_productA",
    },
]
...
def main():
    ...
    print("=" * 80)
    print("CalSimHydro — CalSim Historical Validation Extraction")
