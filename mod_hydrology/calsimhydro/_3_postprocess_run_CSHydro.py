...
OUTPUT_DIR = str(_GEN_DIR / "output" / "_3_postprocess_run_CSHydro")
...
CalSimHydro_rows = df_master[(df_master.iloc[:, 8] == 'CalSimHydro') & (df_master.iloc[:, 9] == 'CS3L2015V0Hydro_SV.dss')]
...
dss_paths = [
    str(_cshydro_runs / "CalSimHydro_Historical_1972-2018" / "CS3L2015V0Hydro_SV.dss"),
    str(_cshydro_runs / "CalSimHydro_VICPrecip_1972-2018" / "CS3L2015V0Hydro_SV.dss"),
    str(_cshydro_runs / "CalSimHydro_QMET_1972-2018" / "CS3L2015V0Hydro_SV.dss"),
    str(_cshydro_runs / "CalSimHydro_Product_A" / "CS3L2015V0Hydro_SV.dss"),
]
...
merged_csv_path = os.path.join(OUTPUT_DIR, "calsimHydro_1972-2018_SV_DSS.csv")
...
summary_output_path = os.path.join(OUTPUT_DIR, "calsimHydro_summary_statistics_by_PartC.csv")
...
# --- Prepare Data ---
plot_df = merged_df[['PartC', 'Historical', 'VIC_Precip', 'QM_ET', 'Product_A']].copy()
plot_df_melted = plot_df.melt(id_vars='PartC',
                              value_vars=['Historical', 'VIC_Precip', 'QM_ET', 'Product_A'],
