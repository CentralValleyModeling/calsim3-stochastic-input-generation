...
*Figure 8. Distribution of percent difference vs. groundwater recharge magnitude in Small Watersheds. Smaller watersheds (lower flow volumes) show proportionally larger percentage differences; larger watersheds cluster near the median of -13.5%. The differences are driven primarily by lower WGEN precipitation.*
