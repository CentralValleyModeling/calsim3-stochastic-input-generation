...
*Figure 9. Delta Channel Depletion differences from historical baseline. Maximum differences range from -166 TAF/yr to +6 TAF/yr across different variables. Percentage differences span -8% to +10%. Overall changes are driven by lower WGEN precipitation.*
