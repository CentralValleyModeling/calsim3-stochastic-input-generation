...
_Quantile mapping example for Folsom inflow (I_FOLSM) from Progress Meeting 1, showing raw VIC basis compared to quantile-mapped output and CalSim 3 target._
