"""
Miscellaneous Product B Quantile Mapping (non-rimflow / non-ET)
===============================================================
Thin wrapper around ``utils.qmap_product_b_from_pairs.
run_product_b_qmap_from_pairs`` for the miscellaneous module: configures
...
Inputs
------
- mod_other/miscellaneous/reference/qmap_pairs.csv
...
Outputs
-------
- output/_4_qmap_product_b/                          intermediate detail CSVs
...
OUT_DIR = _gen / "output" / "_4_qmap_product_b"
